...
describe('calculator functionality', function() {
  ...
  it('should update the running total when a number button is pressed', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number2')).click();
  ...
  it('should update the running total correctly after multiple operations', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number2')).click();
    element(by.css('#operator_add')).click();
    element(by.css('#number3')).click();
  ...
  it('should show "Not a number" if you try to divide by zero', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number2')).click();
    element(by.css('#operator_divide')).click();
